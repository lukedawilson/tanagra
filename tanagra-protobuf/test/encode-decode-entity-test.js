...
describe('#encodeEntity, #decodeEntity', () => {
  ...
  describe('nesting', () => {
    ...
    it('should support array nesting', () => {
      ...
      const withArrayInner = serializable()(WithArrayInner1)
      const withArrayOuter = serializable()(WithArrayOuter1)
    ...
    it('should support 3-level array nesting', () => {
      ...
      const withArrayInner = serializable()(WithArrayInner2)
      const withArrayOuter = serializable()(WithArrayOuter2)
    ...
    it('should support maps of complex types', () => {
      ...
      const classWithComplexMap = serializable()(ClassWithComplexMap1)
    ...
    it('should ignore arrays of arrays', () => {
      ...
      const withArrayOuter = serializable()(WithArrayOuter3)
